        ...
        <div class="col-12">
          ...
          <div class="btn-group d-inline-block float-md-right">
            ...
            <div class="dropdown-menu dropdown-menu-right" role="menu">
              <a href="#" class="dropdown-item">Tất cả chi nhánh</a>
              <a href="#" class="dropdown-item">Chi nhánh 1</a>
              <a href="#" class="dropdown-item">Chi nhánh 2</a>
            </div>
          </div>
        </div>
        <!-- /.end custom filter -->
      ...
      <div class="row mb-3">
        <div class="col-12">
          ...
          <div class="btn-group d-inline-block float-md-right">
            ...
            <div class="dropdown-menu dropdown-menu-right" role="menu">
              <a href="#" class="dropdown-item">7 ngày qua</a>
              <a href="#" class="dropdown-item">2 tuần qua</a>
              <a href="#" class="dropdown-item">1 tháng qua</a>
            </div>
          </div>
        </div>
        <div class="col-md-12">
      ...
      <div class="row mb-3">
        ...
        <div class="col-12">
          ...
          <div class="btn-group d-inline-block float-md-right">
            ...
            <div class="dropdown-menu dropdown-menu-right" role="menu">
              <a href="#" class="dropdown-item">1 ngày qua</a>
              <a href="#" class="dropdown-item">7 ngày qua</a>
              <a href="#" class="dropdown-item">1 tháng qua</a>
            </div>
          </div>
